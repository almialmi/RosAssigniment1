...
namespace gazebo
{
    ...
    public:
        void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
        {
            ...
            ros::ServiceClient client = n.serviceClient<arm_lib::fk>("end_pos");
            arm_lib::fk srv;

            srv.request.joint_angles[0] = 60;
            srv.request.joint_angles[1] = 30;
            srv.request.joint_angles[2] = -90;

            srv.request.joint_angles[3] = -30;
            srv.request.joint_angles[4] =-30;
            srv.request.joint_angles[5] =-60;
            srv.request.joint_angles[6] =-30;
            srv.request.joint_angles[7] =60;
            if (client.call(srv))
             {
                    ROS_INFO("end_effector_pos1: %0.2f,%0.2f,%0.2f", srv.response.endpos[0][3],srv.response.endpos[1][3],srv.response.endpos[2][3]);
            }
            else
            {
    ...
    private:
        ...
        {
            angle[0] = msg->base_arm1_joint;
            angle[1] = msg->arm1_arm2_joint;
            angle[2] = msg->arm2_arm3_joint;
            angle[3] = msg->arm3_arm4_joint;
            p = msg->p;
            i = msg->i;
            d = msg->d;
            update_num = 0;
