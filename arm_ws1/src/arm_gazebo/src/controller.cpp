...
namespace gazebo
{
	...
	public:
		void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
		{
			...
			std::string name2 = this->model->GetJoint("arm2_arm4_joint")->GetScopedName();
	...
	public:
		void OnUpdate()
		{
			...
			double a2 = this->model->GetJoint("arm2_arm3_joint").Position(0);
			double a3 = physics::JointState(this->model->GetJoint("arm3_arm4_joint")).Position(2);
